...
<head>
    ...
    <title>المهام غير المكتملة</title>
    <style>
        body {
                ...
                <li>
                    ...
                    <div>
                        <form action="<?php echo e(route('tasks.complete', $task->id)); ?>" method="POST" style="display:inline;">
                            ...
                            <button type="submit">إنجاز</button>
                        </form>
...
<?php /**PATH C:\Users\Asus\OneDrive\Desktop\todo-list\resources\views/tasks/incomplete.blade.php ENDPATH**/ ?>